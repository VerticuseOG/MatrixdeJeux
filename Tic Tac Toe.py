...
def render_board(board, ximg, oimg): #Updates the Board
...
def add_XO(board, graphical_board, to_move): #Selects who has to move aswell as stores the moves
    ...
    for i in range(3): #Checks if the board is full
        for j in range(3):
